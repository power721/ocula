...
import com.har01d.ocula.FileResultHandler;
import com.har01d.ocula.LogListener;
import com.har01d.ocula.LogResultHandler;
...
public class QuotesSpider {
    public static void main(String[] args) {
        ...
        spider.getResultHandlers().add(new FileResultHandler("/tmp/quotes.json"));
        spider.run();
    }
}
